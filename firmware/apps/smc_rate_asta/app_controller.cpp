...
void AppController::loadSmcParams()
{
    ...
    sf::params::get_float("smc_asta.roll.mref_env_tau",      sta_roll_.mref_env_tau);
    sf::params::get_float("smc_asta.roll.mref_env_base_tau", sta_roll_.mref_env_base_tau);
    sf::params::get_float("smc_asta.roll.mref_trend_floor", sta_roll_.mref_trend_floor);
    ...
    sf::params::get_float("smc_asta.roll.k1_slew_max",        sta_roll_.k1_slew_max);
    ...
    sf::params::get_float("smc_asta.pitch.mref_env_tau",      sta_pitch_.mref_env_tau);
    sf::params::get_float("smc_asta.pitch.mref_env_base_tau", sta_pitch_.mref_env_base_tau);
    sf::params::get_float("smc_asta.pitch.mref_trend_floor", sta_pitch_.mref_trend_floor);
    ...
    sf::params::get_float("smc_asta.pitch.k1_slew_max",        sta_pitch_.k1_slew_max);
    ...
    sf::params::get_float("smc_asta.yaw.mref_env_tau",      sta_yaw_.mref_env_tau);
    sf::params::get_float("smc_asta.yaw.mref_env_base_tau", sta_yaw_.mref_env_base_tau);
    sf::params::get_float("smc_asta.yaw.mref_trend_floor", sta_yaw_.mref_trend_floor);
    ...
    sf::params::get_float("smc_asta.yaw.k1_slew_max",        sta_yaw_.k1_slew_max);
